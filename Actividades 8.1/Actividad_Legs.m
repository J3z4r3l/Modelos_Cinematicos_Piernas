...
H1=SE3(rotz(-pi/2), [0 0 0]); %Inicia 0 prima para completar el ejercicio
H2=SE3(rotx(pi/2), [0 0 2]); %0 a 1 final
H3=SE3(roty(pi/2), [0 0 0]); %1 prima 1 final 
H4=SE3(rotx(0), [1 0 0]); %1 a 2 final
H5=SE3(rotx(0), [1 0 0]); 
H6 = SE3(rotx(0), [1 0 0]); 
...
plot3(x, y, z,'LineWidth', 1.5); axis([-1 5 -10 5 -1 5]); grid on;
hold on;
