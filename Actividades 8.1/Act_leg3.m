...
H1=SE3(rotz(-pi), [0 0 0]); %Inicia 0 prima para completar el ejercicio
H2=SE3(rotz(0), [0 -1 0]); %0 a 1 final
H3=SE3(rotz(0), [0 -3 0]); %1 prima 1 final 
H4=SE3(rotz(0), [0 0 3]); %1 a 2 final
H5=SE3(rotx(0), [-3 0 0]); 
%H6 = SE3(rotz(0), [0 0 0]); 
